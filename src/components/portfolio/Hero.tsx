            ...
            <div className="relative w-full aspect-square max-w-md">
              ...
              <div className="absolute inset-0 glass-panel rounded-3xl shadow-xl flex items-center justify-center p-8 backdrop-blur-sm border border-white/40">
                <div className="text-center">
                  ...
                  <p className="text-foreground/70 mb-4">AI & ML Engineer</p>
                  <div className="flex justify-center space-x-4">
                    <a href="https://github.com/ajvmanumohan" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                    ...
                    <a href="https://www.linkedin.com/in/ajvmanumohan" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"></path>
                      </svg>
                    </a>
                    <a href="mailto:ajvmanumohan@gmail.com" className="hover:text-primary transition-colors">
